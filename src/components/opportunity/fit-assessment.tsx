...
import { calculateFit } from '@/lib/fit-scoring'
import type { OrgProfile, FitResult, OpportunityFitData } from '@/lib/fit-scoring'
import { getOrgProfile, saveOrgProfile } from '@/lib/org-profile-storage'

type FitAssessmentProps = OpportunityFitData
...
export function FitAssessment(props: FitAssessmentProps) {
  ...
  const handleAssess = () => {
    ...
    setResult(fitResult)
    // Save profile to localStorage so it carries to the search page
